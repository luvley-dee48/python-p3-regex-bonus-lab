...
class TestRegEx:
    ...
    def test_finds_all_matches(self):
        ...
        # Find all matches in FINDALL_STRING
        actual_matches = my_regex.findall(FINDALL_STRING)
        
        # Strip whitespace and newline characters from each match
        actual_matches = [sentence.strip() for sentence in actual_matches]
